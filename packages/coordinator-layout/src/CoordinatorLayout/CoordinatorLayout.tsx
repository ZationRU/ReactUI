...
import {getArrayByReactNode, mergeRefs} from "@znui/utils";
 ...
 * @constructor
 */
export const CoordinatorLayout: React.ForwardRefExoticComponent<React.PropsWithoutRef<CoordinatorLayoutProps> & React.RefAttributes<HTMLDivElement>> = React.forwardRef((props: CoordinatorLayoutProps, innerRef: React.ForwardedRef<HTMLDivElement>) => {
...
declare module 'react' {
    ...
    interface Component {
        defaultBehavior?: (() => CoordinatorLayoutBehavior) | undefined
    }
