...
function TextInput(params) {
    ...
    var _a = React.useState(defaultValue), text = _a[0], setText = _a[1];
    var _b = React.useState(false), focused = _b[0], setFocused = _b[1];
    return React__default["default"].createElement("div", { className: classNames("TextInput", params.className) },
        React__default["default"].createElement("fieldset", { className: classNames("TextInput-Inner", focused ? "TextInput-Inner-Focused" : undefined) },
            label && React__default["default"].createElement("legend", { className: "TextInput-Label" }, label) || React__default["default"].createElement("legend", { className: "TextInput-Label", style: { display: "none" } }),
            React__default["default"].createElement("input", __assign({}, props, { onChange: function (event) {
...
function TextArea(params) {
    ...
    return React__default["default"].createElement("div", { className: classNames("TextArea", params.className) },
        placeholder && text.length === 0 && React__default["default"].createElement("div", { className: "TextArea-Placeholder" }, placeholder),
        React__default["default"].createElement("div", __assign({}, props, { onInput: function (e) {
...
function Panel(params) {
    return React__default["default"].createElement("div", null, params.children);
}

function Card(props) {
    return React__default["default"].createElement("div", __assign({}, props, { className: classNames("Card", props.className) }));
}
...
function Hosts(props) {
    ...
    return React__default["default"].createElement("div", __assign({}, otherProps, { className: classNames("Hosts", props.className) }),
        leftNavigation && React__default["default"].createElement("div", { style: { width: leftNavigationWidth }, className: classNames("Hosts-Left") }, leftNavigation),
        React__default["default"].createElement("div", { className: "Hosts-Content" }, !Array.isArray(props.children) ? props.children :
            props.children.find(function (it) { return it.props['id'] == props.activePanel; })),
        bottomNavigation && React__default["default"].createElement(Card, { className: classNames("Hosts-Bottom") }, bottomNavigation));
}

function View(props) {
    return React__default["default"].createElement("div", { className: "View" }, !Array.isArray(props.children) ? props.children :
        props.children.find(function (it) { return it.props['id'] == props.activePanel; }));
}
...
function Avatar(_a) {
    ...
    return React__default["default"].createElement(Card, __assign({}, props, { className: classNames("Avatar", "Avatar-" + (size !== null && size !== void 0 ? size : "medium"), props.className) }), src ? React__default["default"].createElement("img", { src: src, alt: "", loading: "lazy" }) :
        React__default["default"].createElement(SvgUserIcon, null));
}

function AppRoot(params) {
    var _a = params.theme; _a === void 0 ? themeFromSourceColor(0x149C53) : _a;
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "AppRoot" }, params.children));
}

function Div(params) {
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("Div", params.className) }));
}

function GroupRoot(props) {
    return React__default["default"].createElement(Div, null,
        React__default["default"].createElement(Card, __assign({}, props)));
}
...
function Header(props) {
    ...
    return React__default["default"].createElement("div", __assign({}, otherParams, { className: classNames("Header", otherParams.className) }),
        React__default["default"].createElement("div", { className: classNames("Header-Titles", "Header-Titles--" + mode) },
            React__default["default"].createElement("div", { className: "Header-Title" },
                before && React__default["default"].createElement("div", { className: "Header-Before" }, before),
                React__default["default"].createElement("span", null, title),
                indicator && React__default["default"].createElement("div", { className: "Header-Indicator" }, indicator)),
            subtitle && React__default["default"].createElement("div", { className: "Header-Subtitle" }, subtitle)),
        aside && React__default["default"].createElement("div", { className: "Header-Aside" }, aside));
}

function Alert(params) {
    return React__default["default"].createElement(GroupRoot, { className: classNames("Alert", "Alert-" + params.type, params.className) },
        React__default["default"].createElement(Header, { title: params.title, subtitle: params.children }));
}

var Ripple = React__default["default"].memo(function Ripple(_a) {
    ...
    return React__default["default"].createElement("span", { ref: ref });
});
...
function Cell(props) {
    ...
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("Cell", onClick && "Cell-Selectable", params.className), onClick: function (event) {
            var _a;
        ...
        React__default["default"].createElement(Ripple, { onInit: function (struct) {
                rippleStruct = struct;
            } }),
        before && React__default["default"].createElement("i", { className: "Cell-before" }, before),
        React__default["default"].createElement("div", { className: "Cell-inner" },
            React__default["default"].createElement("div", { className: "Cell-Title-Container" },
                params.children && React__default["default"].createElement("div", { className: "Cell-Title" }, params.children),
                titleDescription && React__default["default"].createElement("div", { className: "Cell-Title-Description" }, titleDescription)),
            description && React__default["default"].createElement("div", { className: "Cell-Description" }, description)),
        after && React__default["default"].createElement("div", { className: "Cell-after" }, after));
}

function Group(props) {
    var header = props.header, params = __rest(props, ["header"]);
    return React__default["default"].createElement(GroupRoot, null,
        header && React__default["default"].createElement("div", { className: "Group-Header" }, header),
        React__default["default"].createElement(Div, __assign({}, params)));
}
...
function Toolbar(params) {
    ...
    return React__default["default"].createElement("div", __assign({}, otherParams, { className: classNames("Toolbar", className) }),
        before && React__default["default"].createElement("span", { className: "Toolbar-Before" }, params.before),
        title && React__default["default"].createElement("span", { className: "Toolbar-Title" }, title),
        children && React__default["default"].createElement("div", { className: "Toolbar-Actions" }, children));
}

function HorizontalList(props) {
    return React__default["default"].createElement("div", __assign({}, props, { className: classNames("HorizontalList", props.className) }),
        React__default["default"].createElement("div", { className: "HorizontalList--in" }, props.children));
}

function Tabs(params) {
    return React__default["default"].createElement("div", { className: classNames("Tabs", params.className) },
        React__default["default"].createElement(HorizontalList, null, params.children));
}
...
function TabsItem(params) {
    ...
    var rippleStruct = undefined;
    return React__default["default"].createElement("div", __assign({}, otherParams, { className: "TabsItem " + (selected ? "TabsItem-Active" : ""), onClick: function (event) {
            var _a;
            (_a = rippleStruct === null || rippleStruct === void 0 ? void 0 : rippleStruct.onClick) === null || _a === void 0 ? void 0 : _a.call(rippleStruct, event);
            if (onClick != null) {
                onClick(event);
        ...
        React__default["default"].createElement("div", { className: "TabsItem-Title" }, children),
        selected && React__default["default"].createElement("div", { className: "TabsItem-Indicator" }));
}

function MiniCell(props) {
    var before = props.before, params = __rest(props, ["before"]);
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("MiniCell", params.onClick && "MiniCell-Selectable", params.className) }),
        before && React__default["default"].createElement("i", { className: "MiniCell-before" }, before),
        params.children && React__default["default"].createElement("div", { className: "MiniCell-Title" }, params.children));
}

function AdaptiveList(params) {
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("AdaptiveList", params.className) }));
}

function FormLayout(props) {
    return React__default["default"].createElement("div", __assign({ className: classNames("FormLayout", props.className) }, props));
}

function IconButton(params) {
    var onClick = params.onClick, children = params.children, otherParams = __rest(params, ["onClick", "children"]);
    var rippleStruct = undefined;
    return React__default["default"].createElement("div", __assign({}, otherParams, { className: classNames("IconButton", params.className), onClick: function (event) {
            var _a;
            (_a = rippleStruct === null || rippleStruct === void 0 ? void 0 : rippleStruct.onClick) === null || _a === void 0 ? void 0 : _a.call(rippleStruct, event);
            if (onClick != null) {
                onClick(event);
...
function Link(params) {
    return React__default["default"].createElement("a", __assign({}, params, { className: classNames("Link", params.className) }));
}
...
function Button(props) {
    ...
    var rippleStruct = undefined;
    return React__default["default"].createElement("button", __assign({}, otherProps, { className: classNames("Button", "Card", "Button--" + appearance, "Button--" + mode, stretched && "Button--stretched", otherProps.className), onClick: function (event) {
            var _a;
            (_a = rippleStruct === null || rippleStruct === void 0 ? void 0 : rippleStruct.onClick) === null || _a === void 0 ? void 0 : _a.call(rippleStruct, event);
            if (onClick != null) {
                onClick(event);
        ...
        before && React__default["default"].createElement("div", { className: "Button-Before" }, before),
        React__default["default"].createElement("div", { className: "Button-Text" }, otherProps.children),
        after && React__default["default"].createElement("div", null, after));
}
...
function Spinner(params) {
    ...
    return React__default["default"].createElement("div", __assign({}, props, { className: classNames("Spinner", "Spinner-" + size, params.className) }),
        React__default["default"].createElement(SvgSpinner, null));
}

function PanelSpinner(props) {
    return React__default["default"].createElement("div", __assign({}, props, { className: "PanelSpinner" }),
...
function CellButton(props) {
    ...
    return React__default["default"].createElement("button", __assign({}, otherProps, { className: classNames("CellButton", "CellButton--" + appearance, otherProps.className) }),
        before && React__default["default"].createElement("div", { className: "CellButton-Before" }, before),
        React__default["default"].createElement("div", { className: "CellButton-Text" }, otherProps.children),
        after && React__default["default"].createElement("div", null, after));
}
...
function ViewPager(props) {
    var panels = !Array.isArray(props.children) ? [props.children] :
        props.children;
    return React__default["default"].createElement("div", { className: "ViewPager" }, panels);
}

function NavigationListItem(props) {
    var before = props.before, after = props.after, titleDescription = props.titleDescription, description = props.description, onClick = props.onClick, params = __rest(props, ["before", "after", "titleDescription", "description", "onClick"]);
    var rippleStruct = undefined;
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("NavigationListItem", onClick && "NavigationListItem-Selectable", params.className), onClick: function (event) {
            var _a;
            (_a = rippleStruct === null || rippleStruct === void 0 ? void 0 : rippleStruct.onClick) === null || _a === void 0 ? void 0 : _a.call(rippleStruct, event);
            if (onClick != null) {
                onClick(event);
        ...
        before && React__default["default"].createElement("i", { className: "NavigationListItem-before" }, before),
        React__default["default"].createElement("div", { className: "NavigationListItem-inner" },
            React__default["default"].createElement("div", { className: "NavigationListItem-Title-Container" },
                params.children && React__default["default"].createElement("div", { className: "NavigationListItem-Title" }, params.children),
                titleDescription && React__default["default"].createElement("div", { className: "NavigationListItem-Title-Description" }, titleDescription)),
            description && React__default["default"].createElement("div", { className: "NavigationListItem-Description" }, description)),
        after && React__default["default"].createElement("div", { className: "NavigationListItem-after" }, after));
}

function ModalRoot(props) {
    var dismiss = props.dismiss, className = props.className, children = props.children;
    return React__default["default"].createElement("div", { className: classNames("ModalRoot", className), onClick: function () { return dismiss(undefined); } }, children);
}

function Dialog(props) {
    var dismiss = props.dismiss, className = props.className, children = props.children;
    return React__default["default"].createElement(ModalRoot, { dismiss: dismiss, className: classNames("Dialog", className) },
        React__default["default"].createElement(Card, null, children));
}

function NavigationBottomItem(props) {
    var icon = props.icon, selected = props.selected, params = __rest(props, ["icon", "selected"]);
    return React__default["default"].createElement("div", __assign({}, params, { className: classNames("NavigationBottomItem", params.onClick && "NavigationBottomItem-Selectable", params.className) }),
        React__default["default"].createElement("div", { "data-selected": selected, className: "NavigationBottomItem-Icon" }, icon));
}

function ContextMenu(props) {
    var _a = React.useState({ x: 0, y: 0 }), anchorPoint = _a[0], setAnchorPoint = _a[1];
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { onClick: handleContextMenu }, props.children),
        show && React__default["default"].createElement(Card, { style: {
                position: "absolute",
...
function FloatingActionButton(props) {
    ...
    var rippleStruct = undefined;
    return React__default["default"].createElement("button", __assign({}, otherProps, { className: classNames("FloatingActionButton", "Card", "FloatingActionButton--" + appearance, stretched && "FloatingActionButton--stretched", otherProps.className), style: {
            height: size,
            width: size,
        }, onClick: function (event) {
            var _a;
        ...
        React__default["default"].createElement("div", { className: "FloatingActionButton-Icon" }, icon));
}

function Switch(params) {
    var thumb = React.useRef();
    var checkbox = React.useRef();
    var checked = false;
    return React__default["default"].createElement("div", { className: "Switch", onClick: function () {
            checked = !checked;
        ...
        React__default["default"].createElement("div", { className: "Switch-Thumb", ref: thumb }),
        React__default["default"].createElement("input", { type: "checkbox", ref: checkbox, onChange: function (event) {
...
var SvgCoinIcon = function SvgCoinIcon(props) {
  return /*#__PURE__*/React__namespace.createElement("svg", _extends$q({
    ...
    r: 8,
    fill: "#606060"
  })), _circle2$1 || (_circle2$1 = /*#__PURE__*/React__namespace.createElement("circle", {
    cx: 12,
    cy: 12,
    r: 7,
    fill: "#989898"
...
var SvgDownloadIcon = function SvgDownloadIcon(props) {
  return /*#__PURE__*/React__namespace.createElement("svg", _extends$k({
    ...
    fill: "currentColor"
  })), _path3$8 || (_path3$8 = /*#__PURE__*/React__namespace.createElement("path", {
...
var SvgFeedIcon = function SvgFeedIcon(props) {
  return /*#__PURE__*/React__namespace.createElement("svg", _extends$j({
    ...
    fill: "currentColor"
  })), _path3$7 || (_path3$7 = /*#__PURE__*/React__namespace.createElement("path", {
...
var SvgFollowersIcon = function SvgFollowersIcon(props) {
  return /*#__PURE__*/React__namespace.createElement("svg", _extends$i({
    ...
    stroke: "currentColor",
    strokeWidth: 1.5
  })), _rect$3 || (_rect$3 = /*#__PURE__*/React__namespace.createElement("rect", {
    x: 7.5,
    y: 5.75,
    width: 6,
    height: 6,
...
exports.AdaptiveList = AdaptiveList;
exports.AddIcon = SvgAddIcon;
exports.Alert = Alert;
exports.AppRoot = AppRoot;
exports.AttachIcon = SvgAttachIcon;
exports.Avatar = Avatar;
exports.BackBoldIcon = SvgBackBoldIcon;
exports.BotIcon = SvgBotIcon;
exports.Button = Button;
exports.Card = Card;
exports.Cell = Cell;
exports.CellButton = CellButton;
exports.CoinIcon = SvgCoinIcon;
exports.CommentsIcon = SvgCommentsIcon;
exports.ContextMenu = ContextMenu;
exports.DebugIcon = SvgDebugIcon;
exports.DeleteIcon = SvgDeleteIcon;
exports.Dialog = Dialog;
exports.DialogsIcon = SvgDialogsIcon;
exports.Div = Div;
exports.DoneIcon = SvgDoneIcon;
exports.DownloadIcon = SvgDownloadIcon;
exports.FeedIcon = SvgFeedIcon;
exports.FloatingActionButton = FloatingActionButton;
exports.FollowersIcon = SvgFollowersIcon;
...
exports.LikeIcon = SvgLikeIcon;
exports.Link = Link;
exports.LogoutIcon = SvgLogoutIcon;
exports.MailIcon = SvgMailIcon;
exports.MenuIcon = SvgMenuIcon;
exports.MiniCell = MiniCell;
exports.ModalRoot = ModalRoot;
exports.MoreIcon = SvgMoreIcon;
exports.NavigationBottomItem = NavigationBottomItem;
exports.NavigationListItem = NavigationListItem;
exports.NotificationsIcon = SvgNotificationsIcon;
exports.PaletteIcon = SvgPaletteIcon;
exports.Panel = Panel;
exports.PanelSpinner = PanelSpinner;
exports.PauseIcon = SvgPauseIcon;
exports.PhotoIcon = SvgPhotoIcon;
exports.PlayIcon = SvgPlayIcon;
exports.RepostIcon = SvgRepostIcon;
exports.SelectionsIcon = SvgSelectionsIcon;
...
exports.UserIcon = SvgUserIcon;
exports.VerifiedIcon = SvgVerifiedBoldIcon;
exports.View = View;
