...
import {useAppNavigate, usePageNavigate} from "../router";
...
export function HomePage() {
    ...
    return <VStack ph={6}>
            ...
            action={
                <Layout mt={24}>
                    <znui.button
                        ...
                        onClick={() => pageNavigate("get-started")}
                    >
                        Get started
                    </znui.button>
                </Layout>
        ...
        <VStack maxW={1200} mh='auto' pb={210}>
            ...
            <Section>
                <SectionCard onClick={() => pageNavigate("components")}>
                ...
                <SectionCard onClick={() => navigate("tokens")}>
